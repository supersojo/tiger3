...
main:main.c token.c scanner.c tiger_log.c absyn.c tiger_assert.c types.c
	...
	g++ main.o parser.o scanner.o token.o tiger_log.o absyn.o tiger_assert.o types.o -o main
clean:
	rm main 
	rm main.o 
	rm scanner.o
